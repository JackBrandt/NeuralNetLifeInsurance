...
if __name__ == "__main__":
    ...
    # And layers...
    # With smoothing standard loss function has difference of 0 +- .6%

    # With custom loss function, smoothing, and increased training, difference is 1.5% +- .5%

    # Conclusion standard loss is better